...
##############################################################################  
    ...
    plt.plot(train, y_train, 'r', label='treinamento')
    plt.plot(test, y_test, 'b', label='teste')
    plt.title('Entrada RNA')
    plt.ylabel('SOC')
    plt.xlabel('Tempo (s)')
    ...
    plt.plot(train, X_train[:,0], 'b', label='treinamento')
    plt.plot(train, X_train, 'b', label='treinamento')
    plt.title('Entrada RNA')
    plt.ylabel('SOC')
    plt.xlabel('Tempo (s)')
    plt.legend(framealpha=1, frameon=True);
    ...
    plt.plot(train, X_train[:,1], 'r', label='Agressividade')
    plt.plot(train, X_train[:,2], 'b', label='Liberação')
    plt.title('Entrada RNA')
    plt.ylabel('KPI de Freio')
    plt.xlabel('Tempo (s)')
    plt.legend(framealpha=1, frameon=True);
    plt.show()
    
    plt.plot(train, X_train[:,3], 'r', label='Agressividade')
    plt.plot(train, X_train[:,4], 'b', label='Liberação')
    plt.title('Entrada RNA')
    plt.ylabel('KPI do Acelerador')
    plt.xlabel('Tempo (s)')
    plt.legend(framealpha=1, frameon=True);
    plt.show()
    
    # Plotando os dados X de teste de entrada da Rede Neural     
    plt.plot(test, X_test[:,0], 'b', label='teste')
    plt.title('Entrada RNA')
    plt.ylabel('SOC')
    plt.xlabel('Tempo (s)')
    plt.legend(framealpha=1, frameon=True);
    ...
    plt.plot(test, X_test[:,1], 'r', label='Agressividade')
    plt.plot(test, X_test[:,2], 'b', label='Liberação')
    plt.title('Entrada RNA')
    plt.ylabel('KPI de Freio')
    plt.xlabel('Tempo (s)')
    plt.legend(framealpha=1, frameon=True);
    ...
    plt.plot(test, X_test[:,3], 'r', label='Agressividade')
    plt.plot(test, X_test[:,4], 'b', label='Liberação')
    plt.title('Entrada RNA')
    plt.ylabel('KPI do Acelerador')
    plt.xlabel('Tempo (s)')
    plt.legend(framealpha=1, frameon=True);
...
##############################################################################    
   # Plotando os resultados da Rede Neural Artificial Profunda 
    ...
    plt.plot(range(len(y_test)), y_test, 'r', label='SOC Real')
    #plt.plot(range(len(test)), sochat, 'b', label='ANN SOC Estimator')
    plt.plot(range(len(sochat)), sochat, 'b', label='RNA SOC')
    #plt.plot(range(len(test)), X_test[:,0], 'g', label='SPKF SOC Estimator')
    plt.plot(range(len(y_test)), X_test[:,0], 'g', label='SPKF SOC')
